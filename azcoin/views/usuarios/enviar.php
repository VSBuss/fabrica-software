...
<body>
    ...
    <div class="tela-enviar-az-coins">
        <nav class="nav-tela-enviarAz">
            <div class="container">
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front">
                            <p class="heading_8264">AZCARD</p>
                            <img src="ezgif 4-1.png" alt="" class="logo">
                            ...
                            <p class="valid_thru">DATA ADMISSÂO</p>
                            <p class="date_8264">0 0 / 0 0</p>
                            <p class="name">COLABORADOR</p>
                        </div>
                    ...
                    <div class="wrap-enviar">
                        <form action="enviar-form">
                            ...
                            <div class="wrap-input">
                                ...
                                <select class="btn-enviar-para" name="Colaborador" id="Colaborador"></select>    
                                
                            </div>
                            <div class="wrap-input">
                                <span class="focus-input-form" data-placeholder="Quantia de Azcoins"></span>
                                <input type="quantia" name="quantia" class="input-form" autocomplete="off">
                            </div>
                            <div class="wrap-input-text">
                                
                                <span class="focus-input-form" data-placeholder="Mensagem"></span>
                                <textarea name="mensagem" id="" cols="38" rows="15"></textarea>
                            </div>
                            <div class="container-enviar-form-btn">
                                <button class="enviar-form-btn">ENVIAR</button>
                            </div>
