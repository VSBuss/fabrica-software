...
salto = float(input(f"Primeiro Salto: {salto:.1f} m"))
maior = salto
menor = salto

for x in range(4):
    if x == 0:
        salto = float(input("Segundo Salto: "))
    elif x == 1:
        salto = float(input("Terceiro Salto: "))
    elif x == 2:
        salto = float(input("Quarto Salto: "))
    elif x == 3:
        salto = float(input("Quinto Salto: "))
    if salto > maior:
        maior = salto
    if salto < menor:
        menor = salto